...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 738, 688));
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 643, 305));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 643, 305));
        ...
        up_down_pb = new QPushButton(tab_4);
        up_down_pb->setObjectName(QStringLiteral("up_down_pb"));
        up_down_pb->setMinimumSize(QSize(40, 60));
        ...
        light_pb = new QPushButton(tab_4);
        light_pb->setObjectName(QStringLiteral("light_pb"));
        light_pb->setMinimumSize(QSize(40, 60));
        ...
        bogan_pb = new QPushButton(tab_4);
        bogan_pb->setObjectName(QStringLiteral("bogan_pb"));
        bogan_pb->setMinimumSize(QSize(40, 60));
        ...
        verticalLayout_5->addWidget(debug_tb);
        ...
        verticalLayout_7->addWidget(save_img_pb);
